      ...
      <div>
        ...
        <div className="info">
          ...
          <div className="container">
            <br></br>
            <br></br>
            <Row xs={2} md={3} className="g-4" id="by" class="rounded">
                            ...
                            <table>
                              <tr>
                                ...
                                <td>
                                  ...
                                  >
                                    <a
                                      href={`/hotelpackagedetails/${posts._id}`}
                                      style={{
                                        fontFamily: "Calibri",
                                        textDecoration: "none",
                                        color: "white",
